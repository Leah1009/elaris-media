...
const dictionary = {
  ...
  // Payments area
  payments_subtitle: { en: "Manage how your business gets paid.", es: "Administra cómo recibe pagos tu negocio." },
  pay_tab_overview: { en: "Overview", es: "Resumen" },
  pay_tab_transactions: { en: "Transactions", es: "Transacciones" },
  pay_tab_methods: { en: "Payment Methods", es: "Métodos de Pago" },
  pay_tab_payouts: { en: "Payouts", es: "Depósitos Bancarios" },
  pay_tab_hardware: { en: "Hardware", es: "Equipos de Pago" },
  pay_account_title: { en: "Payment Account", es: "Cuenta de Pagos" },
  pay_account_active: { en: "Payments Active", es: "Pagos Activos" },
  pay_card_payments: { en: "Card Payments", es: "Pagos con Tarjeta" },
  pay_enabled: { en: "Enabled", es: "Habilitado" },
  pay_payouts_label: { en: "Payouts", es: "Depósitos" },
  pay_bank_account: { en: "Bank Account", es: "Cuenta Bancaria" },
  pay_manage_account: { en: "Manage Account", es: "Administrar Cuenta" },
  pay_setup_title: { en: "Accept Card Payments", es: "Acepta Pagos con Tarjeta" },
  pay_setup_body: {
    en: "Accept secure card payments through Luxore for appointments, deposits and checkout.",
    es: "Acepta pagos seguros con tarjeta a través de Luxore para citas, depósitos y cobros.",
  },
  pay_setup_feature_card: { en: "Card payments", es: "Pagos con tarjeta" },
  pay_setup_feature_tap: { en: "Tap to Pay", es: "Tap to Pay" },
  pay_setup_feature_terminal: { en: "Payment terminal", es: "Terminal de pago" },
  pay_setup_feature_deposits: { en: "Online deposits", es: "Depósitos en línea" },
  pay_setup_feature_tips: { en: "Tips", es: "Propinas" },
  pay_setup_feature_refunds: { en: "Refunds", es: "Reembolsos" },
  pay_setup_cta: { en: "Set Up Payments", es: "Configurar Pagos" },
  pay_finish_setup: { en: "Finish Stripe Setup", es: "Completar Configuración" },
  pay_not_connected: { en: "Not connected yet.", es: "Aún no conectado." },
  pay_details_pending: { en: "Account created — finish onboarding to start accepting cards.", es: "Cuenta creada — completa la configuración para aceptar tarjetas." },
  pay_collected_today: { en: "Collected Today", es: "Cobrado Hoy" },
  pay_collected_week: { en: "Collected This Week", es: "Cobrado Esta Semana" },
  pay_tips_week: { en: "Tips This Week", es: "Propinas Esta Semana" },
  pay_refunds_week: { en: "Refunds This Week", es: "Reembolsos Esta Semana" },
  pay_recent_transactions: { en: "Recent Transactions", es: "Transacciones Recientes" },
  pay_no_transactions: { en: "No payments recorded yet. Payments appear here after checkout.", es: "Aún no hay pagos registrados. Aparecerán aquí después de cada cobro." },
  pay_view_all_transactions: { en: "View all transactions →", es: "Ver todas las transacciones →" },
  pay_col_date: { en: "Date", es: "Fecha" },
  pay_col_client: { en: "Client", es: "Cliente" },
  pay_col_method: { en: "Method", es: "Método" },
  pay_col_amount: { en: "Amount", es: "Monto" },
  pay_col_tip: { en: "Tip", es: "Propina" },
  pay_col_total: { en: "Total", es: "Total" },
  pay_col_status: { en: "Status", es: "Estado" },
  pay_filter_today: { en: "Today", es: "Hoy" },
  pay_filter_7d: { en: "7 Days", es: "7 Días" },
  pay_filter_30d: { en: "30 Days", es: "30 Días" },
  pay_filter_custom: { en: "Custom", es: "Personalizado" },
  pay_filter_all_methods: { en: "All Methods", es: "Todos los Métodos" },
  pay_filter_all_status: { en: "All Statuses", es: "Todos los Estados" },
  pay_refund_button: { en: "Refund", es: "Reembolsar" },
  pay_methods_subtitle: { en: "Choose how clients can pay your business.", es: "Elige cómo pueden pagarte tus clientes." },
  pay_methods_card_section: { en: "Card & Digital Payments", es: "Tarjeta y Pagos Digitales" },
  pay_methods_other_section: { en: "Other Payment Methods", es: "Otros Métodos de Pago" },
  pay_methods_requires_stripe: { en: "Requires connected Stripe account", es: "Requiere cuenta de Stripe conectada" },
  pay_methods_requires_device: { en: "Requires a registered device", es: "Requiere un equipo registrado" },
  pay_payouts_available: { en: "Available Balance", es: "Saldo Disponible" },
  pay_payouts_pending: { en: "Pending Balance", es: "Saldo Pendiente" },
  pay_payouts_next: { en: "Recent Payouts", es: "Depósitos Recientes" },
  pay_payouts_not_connected: { en: "Connect Stripe to see your payout balance and history here.", es: "Conecta Stripe para ver tu saldo y depósitos aquí." },
  pay_payouts_none: { en: "No payouts yet.", es: "Aún no hay depósitos." },
  hardware_title: { en: "Payment Hardware", es: "Equipos de Pago" },
  hardware_subtitle: {
    en: "Choose the payment setup that works best for your business.",
    es: "Elige la opción de cobro que mejor se adapte a tu negocio.",
  },
  hardware_tap_dash_headline: { en: "Tap to Pay", es: "Tap to Pay" },
  hardware_tap_dash_body: {
    en: "Accept eligible contactless payments using a supported phone. No separate hardware required.",
    es: "Acepta pagos sin contacto elegibles usando un teléfono compatible. No requiere equipo adicional.",
  },
  hardware_tap_setup_cta: { en: "Set Up Tap to Pay", es: "Configurar Tap to Pay" },
  hardware_not_available_yet: { en: "This device isn't available to order yet — check back soon.", es: "Este equipo aún no está disponible para ordenar — vuelve pronto." },
  hardware_one_time_purchase: { en: "One-time hardware purchase.", es: "Compra única del equipo." },
  hardware_subscription_separate: { en: "Luxore subscription sold separately.", es: "La suscripción de Luxore se vende por separado." },
  hardware_order_reader: { en: "Order Reader", es: "Ordenar Lector" },
  hardware_order_terminal: { en: "Order Terminal", es: "Ordenar Terminal" },
  hardware_order_device: { en: "Order Device", es: "Ordenar Equipo" },
  hardware_your_devices: { en: "Your Devices", es: "Tus Equipos" },
  hardware_connected: { en: "Connected", es: "Conectado" },
  hardware_offline: { en: "Offline", es: "Sin Conexión" },
  hardware_order_title: { en: "Order Hardware", es: "Ordenar Equipo" },
  hardware_quantity: { en: "Quantity", es: "Cantidad" },
  hardware_location: { en: "Location", es: "Ubicación" },
  hardware_shipping_info: { en: "Shipping Information", es: "Información de Envío" },
  hardware_shipping_name: { en: "Full Name", es: "Nombre Completo" },
  hardware_shipping_address1: { en: "Address", es: "Dirección" },
  hardware_shipping_address2: { en: "Apt / Suite (optional)", es: "Depto / Suite (opcional)" },
  hardware_shipping_city: { en: "City", es: "Ciudad" },
  hardware_shipping_state: { en: "State", es: "Estado" },
  hardware_shipping_zip: { en: "ZIP", es: "Código Postal" },
  hardware_shipping_phone: { en: "Phone (optional)", es: "Teléfono (opcional)" },
  hardware_review_order: { en: "Review Order", es: "Revisar Orden" },
  hardware_submit_order: { en: "Submit Order", es: "Enviar Orden" },
  hardware_subtotal: { en: "Subtotal", es: "Subtotal" },

  // Subscription & Billing + Referrals
  subscription_title: { en: "Subscription & Billing", es: "Suscripción y Facturación" },
  subscription_subtitle: { en: "Manage your Luxore plan and billing.", es: "Administra tu plan de Luxore y tu facturación." },
  trial_card_title: { en: "Free Trial", es: "Prueba Gratis" },
  trial_days_remaining: { en: "days remaining", es: "días restantes" },
  trial_day_remaining: { en: "day remaining", es: "día restante" },
  trial_ends_label: { en: "Your trial ends", es: "Tu prueba termina el" },
  trial_choose_plan_prompt: { en: "Choose a plan to continue using Luxore after your trial.", es: "Elige un plan para seguir usando Luxore después de tu prueba." },
  trial_ended_prompt: { en: "Choose a plan to continue using Luxore.", es: "Elige un plan para continuar usando Luxore." },
  choose_a_plan: { en: "Choose a Plan", es: "Elegir un Plan" },
  status_label: { en: "Current Status", es: "Estado Actual" },
  status_free_trial: { en: "Free Trial", es: "Prueba Gratis" },
  days_remaining_label: { en: "Days Remaining", es: "Días Restantes" },
  trial_ends_field: { en: "Trial Ends", es: "La Prueba Termina" },
  selected_plan_label: { en: "Selected Plan", es: "Plan Seleccionado" },
  not_selected: { en: "Not Selected", es: "No Seleccionado" },
  choose_your_plan_title: { en: "Choose Your Plan", es: "Elige Tu Plan" },
  choose_your_plan_subtitle: { en: "Choose the plan that fits your beauty business.", es: "Elige el plan que se adapte a tu negocio de belleza." },
  plan_starter_desc: { en: "For independent professionals and small beauty teams.", es: "Para profesionales independientes y equipos pequeños." },
  plan_pro_desc: { en: "For growing beauty businesses that want more communication, marketing and insights.", es: "Para negocios en crecimiento que buscan más comunicación, marketing y análisis." },
  plan_business_desc: { en: "For larger teams and multi-location beauty businesses.", es: "Para equipos grandes y negocios con múltiples ubicaciones." },
  most_popular_badge: { en: "Most Popular", es: "Más Popular" },
  current_plan_badge: { en: "Current Plan", es: "Plan Actual" },
  per_month: { en: "/month", es: "/mes" },
  plan_staff_count: { en: "staff", es: "personal" },
  plan_location_count: { en: "location", es: "ubicación" },
  plan_locations_count: { en: "locations", es: "ubicaciones" },
  plan_sms_count: { en: "SMS/month", es: "SMS/mes" },
  everything_in_starter: { en: "Everything in Starter", es: "Todo en Starter" },
  everything_in_pro: { en: "Everything in Pro", es: "Todo en Pro" },
  plan_feature_online_booking: { en: "Online Booking", es: "Reservas en Línea" },
  plan_feature_calendar_clients: { en: "Calendar & Clients", es: "Calendario y Clientes" },
  plan_feature_payments: { en: "Payments", es: "Pagos" },
  plan_feature_website: { en: "Business Website", es: "Sitio Web del Negocio" },
  plan_feature_basic_reports: { en: "Basic Reports", es: "Reportes Básicos" },
  plan_feature_all_templates: { en: "All Website Templates", es: "Todas las Plantillas de Sitio Web" },
  plan_feature_two_way: { en: "Two-Way Messaging", es: "Mensajería Bidireccional" },
  plan_feature_marketing: { en: "Marketing", es: "Marketing" },
  plan_feature_advanced_automations: { en: "Advanced Automations", es: "Automatizaciones Avanzadas" },
  plan_feature_advanced_reports: { en: "Advanced Reports", es: "Reportes Avanzados" },
  plan_feature_multi_location: { en: "Multi-Location", es: "Multi-Ubicación" },
  plan_feature_consolidated_reporting: { en: "Consolidated Reporting", es: "Reportes Consolidados" },
  plan_feature_expanded_team: { en: "Expanded Team", es: "Equipo Ampliado" },
  plan_feature_priority_support: { en: "Priority Support", es: "Soporte Prioritario" },
  choose_plan_button: { en: "Choose", es: "Elegir" },
  choose_plan_unavailable_tooltip: {
    en: "Self-service plan changes aren't available yet — your Luxore account manager can switch your plan for you.",
    es: "Los cambios de plan aún no están disponibles en línea — tu asesor de Luxore puede cambiar tu plan por ti.",
  },
  compare_all_features: { en: "Compare All Features", es: "Comparar Todas las Funciones" },
  hide_comparison: { en: "Hide Comparison", es: "Ocultar Comparación" },
  category_core_business: { en: "Core Business", es: "Negocio Principal" },
  category_online: { en: "Online", es: "En Línea" },
  category_clients_forms: { en: "Clients & Forms", es: "Clientes y Formularios" },
  category_operations: { en: "Operations", es: "Operaciones" },
  category_communication: { en: "Communication", es: "Comunicación" },
  category_growth: { en: "Growth", es: "Crecimiento" },
  category_reporting: { en: "Reporting", es: "Reportes" },
  category_business_scale: { en: "Business Scale", es: "Escala del Negocio" },
  billing_section_title: { en: "Billing", es: "Facturación" },
  billing_status: { en: "Status", es: "Estado" },
  billing_plan: { en: "Plan", es: "Plan" },
  billing_cycle: { en: "Billing Cycle", es: "Ciclo de Facturación" },
  billing_monthly: { en: "Monthly", es: "Mensual" },
  billing_next_date: { en: "Next Billing Date", es: "Próxima Fecha de Facturación" },
  billing_payment_method: { en: "Payment Method", es: "Método de Pago" },
  billing_not_set_up: { en: "Not set up", es: "No configurado" },
  billing_manage: { en: "Manage Billing", es: "Administrar Facturación" },
  billing_change_plan: { en: "Change Plan", es: "Cambiar Plan" },
  refer_earn_title: { en: "Refer & Earn $50", es: "Refiere y Gana $50" },
  refer_earn_dashboard_body: {
    en: "Know another beauty business that would love Luxore? Refer them to Luxore and earn a $50 reward after they become an eligible paying customer.",
    es: "¿Conoces otro negocio de belleza al que le encantaría Luxore? Refiérelo a Luxore y recibe una recompensa de $50 cuando se convierta en un cliente de pago elegible.",
  },
  refer_earn_subscription_body: {
    en: "Refer another beauty business to Luxore. When they register through your referral and become an eligible paying Luxore customer, you earn a $50 reward.",
    es: "Refiere otro negocio de belleza a Luxore. Cuando se registre a través de tu referido y se convierta en un cliente de pago elegible, recibes una recompensa de $50.",
  },
  invite_a_business: { en: "Invite a Business", es: "Invitar un Negocio" },
  your_referral_link: { en: "Your Referral Link", es: "Tu Enlace de Referido" },
  share_button: { en: "Share", es: "Compartir" },
  referral_activity_title: { en: "Referral Activity", es: "Actividad de Referidos" },
  referral_col_referral: { en: "Referral", es: "Referido" },
  referral_col_status: { en: "Status", es: "Estado" },
  referral_col_reward: { en: "Reward", es: "Recompensa" },
  referral_no_activity: { en: "No referrals yet — share your link to start earning.", es: "Aún no hay referidos — comparte tu enlace para empezar a ganar." },
  referral_status_signed_up: { en: "Signed Up", es: "Registrado" },
  referral_status_trialing: { en: "Trial", es: "Prueba" },
  referral_status_qualified: { en: "Qualified", es: "Calificado" },
  referral_status_rejected: { en: "Rejected", es: "Rechazado" },
  reward_status_pending: { en: "Pending", es: "Pendiente" },
  reward_status_qualified: { en: "$50 Earned", es: "$50 Ganados" },
  reward_status_issued: { en: "Issued", es: "Entregado" },
  referral_terms_apply: { en: "Referral Terms Apply", es: "Aplican Términos de Referido" },
  referral_total_referrals: { en: "Referrals", es: "Referidos" },
  referral_successful: { en: "Successful Referrals", es: "Referidos Exitosos" },
  referral_rewards_earned: { en: "Rewards Earned", es: "Recompensas Ganadas" },
