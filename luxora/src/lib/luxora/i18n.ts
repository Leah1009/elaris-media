...
const dictionary = {
  ...
  // Reports page
  reports_subtitle: {
    en: "Understand your revenue, appointments, clients and team performance.",
    es: "Entiende tus ingresos, citas, clientes y el desempeño de tu equipo.",
  },
  export_csv: { en: "Export CSV", es: "Exportar CSV" },
  report_period_7: { en: "7 Days", es: "7 Días" },
  report_period_30: { en: "30 Days", es: "30 Días" },
  report_period_90: { en: "90 Days", es: "90 Días" },
  report_period_365: { en: "1 Year", es: "1 Año" },
  report_period_all: { en: "All Time", es: "Todo el Tiempo" },
  report_period_custom: { en: "Custom", es: "Personalizado" },
  report_from: { en: "From", es: "Desde" },
  report_to: { en: "To", es: "Hasta" },
  report_apply: { en: "Apply", es: "Aplicar" },
  all_locations: { en: "All Locations", es: "Todas las Ubicaciones" },
  location_label: { en: "Location", es: "Ubicación" },
  tab_overview: { en: "Overview", es: "Resumen" },
  tab_revenue: { en: "Revenue", es: "Ingresos" },
  tab_appointments: { en: "Appointments", es: "Citas" },
  tab_clients: { en: "Clients", es: "Clientes" },
  tab_services: { en: "Services", es: "Servicios" },
  tab_staff: { en: "Staff", es: "Equipo" },
  kpi_gross_revenue: { en: "Gross Revenue", es: "Ingresos Brutos" },
  kpi_net_revenue: { en: "Net Revenue", es: "Ingresos Netos" },
  kpi_refunds: { en: "Refunds", es: "Reembolsos" },
  kpi_appointments: { en: "Appointments", es: "Citas" },
  kpi_avg_ticket: { en: "Average Ticket", es: "Ticket Promedio" },
  kpi_new_clients: { en: "New Clients", es: "Clientes Nuevos" },
  kpi_returning_clients: { en: "Returning Clients", es: "Clientes Recurrentes" },
  kpi_clients_served: { en: "Clients Served", es: "Clientes Atendidos" },
  kpi_deposits_collected: { en: "Deposits Collected", es: "Depósitos Cobrados" },
  kpi_transactions: { en: "transactions", es: "transacciones" },
  appointments_overview_title: { en: "Appointments", es: "Citas" },
  clients_overview_title: { en: "Clients", es: "Clientes" },
  appt_total: { en: "Total", es: "Total" },
  appt_completed: { en: "Completed", es: "Completadas" },
  appt_cancelled: { en: "Cancelled", es: "Canceladas" },
  appt_no_show: { en: "No-Shows", es: "Ausencias" },
  appt_pending: { en: "Pending", es: "Pendientes" },
  cancellation_rate_label: { en: "Cancellation Rate", es: "Tasa de Cancelación" },
  top_services_title: { en: "Top Services", es: "Servicios Principales" },
  top_staff_title: { en: "Top Staff", es: "Equipo Principal" },
  view_services_report: { en: "View Services Report →", es: "Ver Reporte de Servicios →" },
  view_staff_report: { en: "View Staff Report →", es: "Ver Reporte de Equipo →" },
  no_revenue_data: { en: "No revenue data for this period.", es: "Sin datos de ingresos en este período." },
  no_appointments_data: { en: "No appointments for this period.", es: "Sin citas en este período." },
  no_service_data: { en: "No service performance data yet.", es: "Aún no hay datos de desempeño de servicios." },
  no_staff_data: { en: "No payments tied to staff in this period.", es: "Sin pagos asociados a personal en este período." },
  no_client_data: { en: "No client data for this period.", es: "Sin datos de clientes en este período." },
  report_col_service: { en: "Service", es: "Servicio" },
  report_col_appointments: { en: "Appointments", es: "Citas" },
  report_col_revenue: { en: "Revenue", es: "Ingresos" },
  report_col_pct_revenue: { en: "% of Revenue", es: "% de Ingresos" },
  report_col_staff: { en: "Staff", es: "Personal" },
  report_col_avg_ticket: { en: "Avg Ticket", es: "Ticket Prom." },
  report_col_tips: { en: "Tips", es: "Propinas" },
  report_col_client: { en: "Client", es: "Cliente" },
  report_col_visits: { en: "Visits", es: "Visitas" },
  report_col_last_visit: { en: "Last Visit", es: "Última Visita" },
  payment_method_breakdown_title: { en: "Payment Method Breakdown", es: "Desglose por Método de Pago" },
  appointments_by_day_title: { en: "Appointments by Day of Week", es: "Citas por Día de la Semana" },
  appointments_by_time_title: { en: "Appointments by Time of Day", es: "Citas por Hora del Día" },
  new_vs_returning_title: { en: "New vs Returning", es: "Nuevos vs Recurrentes" },
  top_clients_by_spend_title: { en: "Top Clients by Spend", es: "Mejores Clientes por Gasto" },
  inactive_clients_title: { en: "Inactive Clients (90+ days)", es: "Clientes Inactivos (90+ días)" },
  sort_most_booked: { en: "Most Booked", es: "Más Reservados" },
  sort_highest_revenue: { en: "Highest Revenue", es: "Mayores Ingresos" },
  day_sun_short: { en: "Sun", es: "Dom" },
  day_mon_short: { en: "Mon", es: "Lun" },
  day_tue_short: { en: "Tue", es: "Mar" },
  day_wed_short: { en: "Wed", es: "Mié" },
  day_thu_short: { en: "Thu", es: "Jue" },
  day_fri_short: { en: "Fri", es: "Vie" },
  day_sat_short: { en: "Sat", es: "Sáb" },
  chart_gross: { en: "Gross", es: "Bruto" },
  chart_net: { en: "Net", es: "Neto" },
