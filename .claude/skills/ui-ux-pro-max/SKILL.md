...
The search script lives inside this skill's own directory. In this repo it is installed at `.claude/skills/ui-ux-pro-max/` — run the commands below from the repository root:
